...
// Alunos: Gabriel Souza, Gabriel Cavalheiro e Marcus Vínicius
// Algoritimo para ver o tempo que leva para excluir um determinado elemento na Estrutura Lista Simplesmente Encadeada

public class TesteExcluirElemento_LSE {
	...
	public static void main(String[] args) {
		...
		// Esse elemento desejado é o elemento pra excluir da lista
