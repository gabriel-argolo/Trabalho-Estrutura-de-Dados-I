...
// Algoritimo para ver o tempo que leva para Buscar um Determinado elemento na Estrutura Lista Duplamente Encadeada

public class TesteBuscar_LDE {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tamanho da Lista: " + lde.tamanho());
