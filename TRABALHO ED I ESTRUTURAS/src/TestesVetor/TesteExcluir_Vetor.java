...
public class TesteExcluir_Vetor {
	...
	public static void main(String[] args) {
		...
		int elementoRemover = 1900000;
		// utilizei esse comando para remover um determinado elemento

		vetor.remove(elementoRemover);
		...
		System.out.println("Tempo Gasto para Excluir o Elemento: "+elementoRemover);
